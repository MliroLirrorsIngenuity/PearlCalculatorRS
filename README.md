...
推荐搭配 [carpet-ftlconfig](https://github.com/MliroLirrorsIngenuity/carpet-ftlconfig) 使用，它是一个 Carpet 扩展，可在游戏内快速创建珍珠炮配置文件，省去手动测量与填写参数。
...
- [LegendsOfSky/PearlCalculatorCore](https://github.com/LegendsOfSky/PearlCalculatorCore)：本项目物理计算核心思路参考自该项目
